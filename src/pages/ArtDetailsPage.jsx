...
const ArtDetailsPage = () => {
  const { id } = useParams();
  const { data } = useSingleArt(id);
  return (
    <section>
      <div className="mx-auto max-w-screen-2xl px-4">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-center py-20">
          <h2 className="mx-auto mb-12  max-w-4xl text-center text-4xl font-semibold uppercase md:text-5xl">
                ...
                <div className="flex flex-col items-start justify-center gap-3">
                  ...
                  <div className="flex w-full flex-wrap items-center  justify-between gap-3">
                    ...
                    <div className="my-3 flex flex-wrap gap-4">
                      <p className=" rounded-sm bg-[#D2AB67] px-2 py-1 text-xs capitalize italic text-white">
                        Customizable: {data?.customizable}
                      </p>
                      <p className=" rounded-sm bg-[#665DCD] px-2 py-1 text-xs capitalize italic text-white">
                        Artist: {data?.posted_by_name}
                      </p>
                      <p className=" rounded-sm bg-[#5FA4E6] px-2 py-1 text-xs capitalize italic text-white">
          ...
          <Link
            to={".."}
            className="mt-8 flex items-center justify-center gap-4 rounded-md px-5 py-3 font-semibold uppercase transition duration-150 hover:text-[#5FA4E6] md:self-end"
          >
